      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-3 px-1">
            <Target className="w-3.5 h-3.5 text-indigo-400/50" />
        ...
        {/* Right: Platforms & Formats */}
        <div className="space-y-10">
          <div className="space-y-8">
            <div className="flex items-center gap-3 px-1">
              <CheckSquare className="w-3.5 h-3.5 text-indigo-400/50" />
              <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-white/20">
                Network Propagation
              </label>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {platforms.map((platform) => (
                <button
                  ...
                  className={clsx(
                    "flex flex-col gap-2 p-4 rounded-2xl border transition-all text-left group relative overflow-hidden",
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3 px-1">
              <AlignJustify className="w-3.5 h-3.5 text-indigo-400/50" />
              <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-white/20">
                Format Selection
              </label>
            </div>
            ...
            {selectedPlatforms.length === 0 ? (
              <div className="p-8 rounded-2xl border border-white/5 bg-white/[0.02] border-dashed text-center">
                  ...
                  return (
                    <div key={plat.id} className="space-y-3">
                      <div className="flex items-center gap-2 px-1">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest text-white/40">{plat.name}</span>
                      </div>
                      <div className="grid grid-cols-1 gap-2">
                        {plat.formats.map((format) => (
                          ...
                          >
                            <span className={clsx(
                                "text-xs font-bold",
                                selectedFormats.includes(format.id) ? "text-white" : "text-white/40"
                            )}>
                                {format.name}
                            </span>
                            <div className={clsx(
