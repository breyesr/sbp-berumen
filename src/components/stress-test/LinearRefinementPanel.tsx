...
interface LinearRefinementPanelProps {
    result: StressResult;
...
export function LinearRefinementPanel({
    result,
    refineLoading,
    refineError,
    refineQuestions,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8 animate-fade-in">
            ...
            <div className="lg:col-span-1">
                <div className="sticky top-8 space-y-6">
                    ...
                    {/* Dynamic Context Box */}
                    {!isRefinado ? (
                        /* State A: Contexto del Análisis (Balanced) */
                        ...
                        /* State B: Cambios Clave (What Changed) */
